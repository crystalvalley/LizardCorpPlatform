namespace LizardCorpBot.Services
{
    ...
    public class InteractionHandlerService(DiscordSocketClient client, ILogger<InteractionHandlerService> logger, IServiceProvider provider, InteractionService interactionService, IConfiguration config, IHostEnvironment environment) : DiscordClientService(client, logger)
    {
