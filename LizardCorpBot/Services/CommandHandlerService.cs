namespace LizardCorpBot.Services
{
    ...
    /// </summary>
    /// <remarks>
    /// <see cref="CommandHandlerService"/> 클래스의 생성자.
    /// </remarks>
    ...
    public class CommandHandlerService(DiscordSocketClient client, ILogger<CommandHandlerService> logger, IServiceProvider provider, CommandService commandService, IConfiguration config) : DiscordClientService(client, logger)
    {
        ...
        /// <returns><see cref="Task"/>를 반환함.</returns>
